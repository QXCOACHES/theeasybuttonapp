...
function Step8({A,setA,next}) {
  ...
  async function genExample() {
    ...
    try {
      const t=await callClaude(SYS,
        `Write a "Remember When" example for this person. They are speaking from their NEW identity, 2 years in the future. They are reminiscing about specific GOOD MOMENTS that happened because of their new identity. DO NOT reference the old belief or old pattern at all — not even as a contrast. The old story is completely gone. This is purely about the new life.

New declaration: "${A.declare}"
Focus area: "${focus}"

Write 5-6 sentences. Each one is a specific, joyful, grounded memory of a moment that happened BECAUSE they were living their new identity. Like telling a friend about highlights from the last two years. "Remember when I..." followed by a specific moment, a result, a feeling — all from the new story. No before/after. No contrast. Just life as the new self, remembered fondly. Make it specific to ${focus}. Plain, warm, real.

Example of the RIGHT tone: "Remember when I expressed my feelings clearly with my partner and it actually brought us closer instead of further apart? Remember when I got offered that contract because I just asked for what I was worth? Remember when I realized I'd gone three months without that anxious voice in my head telling me I was too much?"

That's the register. Pure new story. Nothing about the old one.`)
      setExample(t)
    ...
    <Shell n={8} icon="✧" label="Remember When">
      ...
      {example&&(
        <div className="fade-in">
          ...
          {exDone&&(
            <div className="fade-in">
              <p style={{color:'var(--muted)',lineHeight:1.8,marginBottom:24,fontSize:15,fontFamily:'Lato,sans-serif'}}>Now say your own out loud. Speak purely from the new story — specific moments, things that happened, life as the person you declared yourself to be. No reference to the old pattern. Just the new life, remembered. Say it out loud first, then write it.</p>
              <Q text="Remember when..." sub="Specific moments from your new life. Pure new identity. No reference to the old story."/>
